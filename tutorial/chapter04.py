...
users = {
    ...
    "user02": {"username": "user02", "password": "123456", "email": "user02@example.com", "mobile": "110","full_name":"Choujie"}
}
...
@app04.post(
    ...
    description="This is description",#请求描述
    response_description="This is response description",#相应描述
